...
module.exports.specialResolveSD = specialResolveSD; 
function specialResolveSD (str, yyyy) {
...
module.exports.queryFestival = queryFestival;
function queryFestival(yyyy, festivals, queryList) {
    ...
    for(var ty in query_obj){
        ...
        for(var sp_day in obj){
            let solar_date = new Date(specialResolveSD(sp_day, yyyy));
